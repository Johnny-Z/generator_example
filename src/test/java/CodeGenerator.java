...
import static com.generator_example.demo.core.ProjectConstant.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/springbootdb";
    ...
    private static final String AUTHOR = "Johnny-Z";//@author
